...
OpenDataflowValue raw_open_dataflow_value_from_output_graph_expr_value(OutputGraphExprValue const &v) {
...
OutputGraphExprValue output_graph_expr_value_from_raw_open_dataflow_value(OpenDataflowValue const &v) {
