...
PCGOperatorAttrs materialize_output_operator_from_attrs_assignment(
  ...
  std::unordered_map<OperatorAttributeKey, OperatorAttributeValue> template_attrs_map = [&]() -> std::unordered_map<OperatorAttributeKey, OperatorAttributeValue> {
  ...
  std::unordered_map<OperatorAttributeKey, OperatorAttributeValue> assignments_attrs_map =
  ...
  std::unordered_map<OperatorAttributeKey, OperatorAttributeValue> joined_attrs_map = merge_maps(
    template_attrs_map,
