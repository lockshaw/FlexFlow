...
Substitution get_data_parallelism_substitution(int_ge_two degree) {
  ...
  OutputOperatorAttrsAssignment o_input_node_expr =
      output_operator_clone_node(b.pattern_node_named(input_node_name));

  OutputGraphExprValue o_unpartitioned_input =
