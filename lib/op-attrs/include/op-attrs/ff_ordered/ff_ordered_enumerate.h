#ifndef _FLEXFLOW_LIB_OP_ATTRS_INCLUDE_OP_ATTRS_FF_ORDERED_FF_ORDERED_ENUMERATE_H
#define _FLEXFLOW_LIB_OP_ATTRS_INCLUDE_OP_ATTRS_FF_ORDERED_FF_ORDERED_ENUMERATE_H
 ...
 */
template <typename T>
std::map<ff_dim_t, T> ff_ordered_enumerate(FFOrdered<T> const &ff_ordered) {
