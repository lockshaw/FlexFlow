...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("perform_copy_insertion") {
    ...
    auto mk_value_attrs = [](size_t src_layer_guid,
                             ...
                             std::optional<ParallelTensorMapping> const &mapping) -> DynamicValueAttrs {
    ...
    auto mk_ptensor_coord = [](nonnegative_int shard_idx) -> ParallelTensorSpaceCoordinate {
    ...
    auto mk_machine_coord = [](nonnegative_int device_idx) -> MachineSpaceCoordinate {
    ...
    auto mk_node_attrs = [](dynamic_layer_guid_t layer_guid,
                            std::optional<DynamicNodeMapping> const &mapping,
                            std::optional<TrainingOperationAttrs> const &op_attrs) -> DynamicNodeAttrs {
    ...
    auto mk_binding = [&](
      nonnegative_int input_shard_idx,
    ...
    SUBCASE("inserts copy when necessary") {
      ...
      DynamicNodeInvocation inv1 = DynamicNodeInvocation{
        ...
        /*node_attrs=*/mk_node_attrs(mk_pcg_layer_guid(1), mapping1, /*op_attrs=*/std::nullopt),
        /*outputs=*/{
          {
      ...
      DynamicNodeInvocation inv2 = DynamicNodeInvocation{
        ...
        /*node_attrs=*/mk_node_attrs(mk_pcg_layer_guid(2), mapping2, /*op_attrs=*/std::nullopt),
        /*outputs=*/{
          {
            mk_slot(TensorSlotName::OUTPUT),
            v3,
      ...
      DynamicOpenDataflowGraph correct = [&] {
        ...
        return dynamic_open_dataflow_graph_from_invocation_set({mapped_inv1, mapped_inv2, inserted_copy});
      }();
    ...
    SUBCASE("does not insert a copy when not necessary") {
      ...
      DynamicOpenDataflowGraph correct = [&] {
        ...
        return dynamic_open_dataflow_graph_from_invocation_set({mapped_inv1, mapped_inv2});
      }();
