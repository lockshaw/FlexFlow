    ...
    std::function<std::vector<SlotName>(std::unordered_set<SlotName> const &)> const &order_slots)
{
  ...
  std::function<nlohmann::json(OpenKwargDataflowValue<GraphInputName, SlotName> const &)> render_value = 
    [&](OpenKwargDataflowValue<GraphInputName, SlotName> const &v) -> nlohmann::json {
