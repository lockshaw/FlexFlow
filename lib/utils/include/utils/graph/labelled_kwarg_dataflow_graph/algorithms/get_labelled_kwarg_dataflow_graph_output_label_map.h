...
std::unordered_map<KwargDataflowOutput<SlotName>, OutputLabel> get_labelled_kwarg_dataflow_graph_output_label_map(
  LabelledKwargDataflowGraphView<NodeLabel, OutputLabel, SlotName> const &g)
{
  return generate_map(get_all_kwarg_dataflow_outputs(g),
