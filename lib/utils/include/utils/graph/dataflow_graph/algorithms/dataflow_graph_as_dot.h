...
std::string dataflow_graph_as_dot(
  ...
  std::optional<std::function<std::string(Node const &)>> const &get_node_label = std::nullopt,
  std::optional<std::function<std::string(DataflowInput const &)>> const &get_input_label = std::nullopt,
  std::optional<std::function<std::string(DataflowOutput const &)>> const &get_output_label = std::nullopt);
