...
struct ViewFromDataflowGraphData final
  : virtual public IDataflowGraphView {
...
public:
  ...
  std::unordered_set<DataflowEdge> query_edges(DataflowEdgeQuery const &query) const override;
  std::unordered_set<DataflowOutput> query_outputs(DataflowOutputQuery const &query) const override;
