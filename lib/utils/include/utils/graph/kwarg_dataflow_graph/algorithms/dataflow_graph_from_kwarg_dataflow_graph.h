...
{
  KwargDataflowGraphData<SlotName> kwarg_data = get_kwarg_dataflow_graph_data(kwarg_dg);

  DataflowGraphData result_data = dataflow_graph_data_from_kwarg_dataflow_graph_data(kwarg_data, order_slots);
