...
MAKE_SUBTYPING_RELATION(graph_subtype, OpenMultiDiGraphView, MultiDiGraphView);
...
MAKE_SUBTYPING_RELATION(graph_subtype, OpenMultiDiGraph, OpenMultiDiGraphView);
...
MAKE_SUBTYPING_RELATION(graph_subtype, UpwardOpenMultiDiGraphView, MultiDiGraphView);
...
public:
  ...
  operator UpwardOpenMultiDiGraphView() const;
...
MAKE_SUBTYPING_RELATION(graph_subtype, UpwardOpenMultiDiGraph, UpwardOpenMultiDiGraphView);
...
MAKE_SUBTYPING_RELATION(graph_subtype, DownwardOpenMultiDiGraphView, MultiDiGraphView);
...
public:
  ...
  operator DownwardOpenMultiDiGraphView() const;
...
MAKE_SUBTYPING_RELATION(graph_subtype, DownwardOpenMultiDiGraph, DownwardOpenMultiDiGraphView);
