...
MAKE_SUBTYPING_RELATION(graph_subtype, LabelledOpenMultiDiGraphView, 4, OpenMultiDiGraphView);
...
MAKE_SUBTYPING_RELATION(graph_subtype, LabelledOpenMultiDiGraph, 4, LabelledOpenMultiDiGraphView, 4);
