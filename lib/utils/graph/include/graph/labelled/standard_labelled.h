...
MAKE_SUBTYPING_RELATION(graph_subtype, LabelledMultiDiGraphView, 2, NodeLabelledMultiDiGraphView, 1);
...
MAKE_SUBTYPING_RELATION(graph_subtype, LabelledMultiDiGraph, 2, LabelledMultiDiGraphView, 2);
