...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("open_kwarg_dataflow_graphs_are_isomorphic_under") {
    ...
    for (std::vector<Node> ordered_rhs_nodes : get_all_permutations(rhs_nodes)) {
      OpenKwargDataflowGraphIsomorphism<std::string> iso = OpenKwargDataflowGraphIsomorphism<std::string>{
        /*node_mapping=*/bidict_from_keys_and_values(ordered_lhs_nodes, ordered_rhs_nodes),
        /*input_mapping=*/{},
      };
