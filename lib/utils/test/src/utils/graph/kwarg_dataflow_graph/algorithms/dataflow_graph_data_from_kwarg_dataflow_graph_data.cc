...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("dataflow_graph_data_from_kwarg_dataflow_graph_data") {
    ...
    auto mk_kwarg_edge = [](KwargDataflowOutput<std::string> const &src,
                            Node dst_node,
    ...
    DataflowGraphData result = dataflow_graph_data_from_kwarg_dataflow_graph_data(input, slot_ordering);
