...
using namespace ::FlexFlow;
  ...
  TEMPLATE_TEST_CASE("inplace_filter(TestType, F)",
                     "",
                     std::vector<int>,
    ...
    rc::prop("inplace_filter returns empty for predicate always_false",
               [](TestType t) {
    ...
    rc::prop("inplace_filter returns input for predicate always_true",
               [](TestType t) {
                 TestType input = t;
