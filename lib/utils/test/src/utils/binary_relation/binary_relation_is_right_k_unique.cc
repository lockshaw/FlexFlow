...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("binary_relation_is_right_k_unique") {
    std::string s_a = "a";
    std::string s_b = "b";
    std::string s_c = "c";
    std::string s_d = "d";
    ...
    SUBCASE("binary relation is right 3-unique") {
      ...
      std::optional<nonnegative_int> result = binary_relation_is_right_k_unique(rel);
    ...
    SUBCASE("binary relation is left k-unique") {
      BinaryRelation<int, std::string> rel = {
        {1, s_a},
        {2, s_a},
        {3, s_a},
