...
TEST_SUITE(FF_TEST_SUITE) {
  ...
  TEST_CASE("binary_merge_disjoint_bidicts") {
    ...
    SUBCASE("overlapping key, different associated value") {
      ...
      CHECK_THROWS(binary_merge_disjoint_bidicts(bd1, bd2));
    }
