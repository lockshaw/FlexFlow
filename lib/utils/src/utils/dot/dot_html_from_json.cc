...
DotHtmlTable dot_html_table_from_json(nlohmann::json const &j) {
  auto mk_table_from_rows = [](std::vector<DotHtmlTableRow> const &rows) -> DotHtmlTable {
    return DotHtmlTable{
      /*border=*/0_n,
      /*cellborder=*/1_n,
      /*cellspacing=*/0_n,
  ...
  auto mk_kv_row = [&](std::string const &k, nlohmann::json const &v) -> DotHtmlTableRow {
    return DotHtmlTableRow{
      /*cells=*/{
        DotHtmlTableCell{
          /*content=*/DotHtmlTableCellContents{
...
DotHtmlTableCell dot_html_cell_from_json(nlohmann::json const &j) {
  ...
  switch (j.type()) {
    ...
    case nlohmann::json::value_t::boolean:
      return mk_cell_from_string(
        fmt::to_string(j.get<bool>()));
    case nlohmann::json::value_t::string:
      return mk_cell_from_string(
        j.get<std::string>());
    case nlohmann::json::value_t::number_integer:
      return mk_cell_from_string(
        fmt::to_string(j.get<int>()));
    case nlohmann::json::value_t::number_unsigned:
      return mk_cell_from_string(
        fmt::to_string(j.get<unsigned int>()));
    case nlohmann::json::value_t::number_float:
      return mk_cell_from_string(
        fmt::to_string(j.get<float>()));
    case nlohmann::json::value_t::object:
    case nlohmann::json::value_t::array:
      return mk_cell_from_table(
        dot_html_table_from_json(j));
    case nlohmann::json::value_t::binary:
    case nlohmann::json::value_t::discarded:
    default:
      PANIC("Unhandled value_t", j.type());
