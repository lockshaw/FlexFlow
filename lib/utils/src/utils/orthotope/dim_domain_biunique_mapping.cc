...
template DimDomainBiuniqueMapping<L, R> empty_dim_domain_mapping();

template DimDomainBiuniqueMapping<R, L>
    invert_dim_domain_mapping(DimDomainBiuniqueMapping<L, R> const &);
...
template DimDomainBiuniqueMapping<T1, T3>
    compose_dim_domain_mappings(DimDomainBiuniqueMapping<T1, T2> const &,
