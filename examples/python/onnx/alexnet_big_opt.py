...
def top_level_task():
  ...
  onnx_model = ONNXModel(f"{MODEL_DIRECTORY}/alexnet{model_tag}_{ffconfig.get_batch_size()}_{optimized_suffix}_n10_alpha1.5_g1.onnx")
  t = onnx_model.apply(ffmodel, {"data": input})
  # t = ffmodel.dense(t, 4096 * 4, ActiMode.AC_MODE_RELU, name='HEYA4')
  # t = ffmodel.dense(t, 4096 * 4, ActiMode.AC_MODE_RELU, name='HEYA5')
