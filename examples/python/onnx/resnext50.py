...
MODEL_DIRECTORY = "/home/groups/aaiken/unger/models/resnext50-2"
...
def top_level_task():
  ...
  onnx_filename = f"{MODEL_DIRECTORY}/resnext50{model_tag}_{ffconfig.get_batch_size()}_{optimized_suffix}.onnx"
